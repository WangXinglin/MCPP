...
```
Theorem: Let A and B be nxn matrices. If AB = I where I is the identity matrix, then det(A) ≠ 0 and det(B) = 1/det(A).
...
[
  {
    "id": "tc_1",
    "natural_language": "Let A and B be nxn matrices.",
    "statement": "Premise:\n• A and B are nxn real matrices [tc_1]",
    "dependencies": []
  },
  {
    "id": "tc_2",
    "natural_language": "AB = I where I is the identity matrix.",
    "statement": "Premise:\n •A and B are nxn real matrices [tc_1] •AB = I where I is the identity matrix [tc_2]", 
    "dependencies": ["tc_1"]
  },
  {
    "id": "l1",
