...
def main(args):
    ...
    codeflow_root = Path(__file__).resolve().parents[2]
    final_output_dir = codeflow_root / "output" / dir_output
    final_output_dir.mkdir(parents=True, exist_ok=True)
    final_output_path = final_output_dir / f"{model_name}_single_turn.json"
